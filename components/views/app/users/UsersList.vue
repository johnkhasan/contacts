<template>
  <Table
    ...
    :permissions="{
      edit: [PERMISSION_KEYS.UPDATE_ACCOUNT],
      delete: [PERMISSION_KEYS.DELETE_ACCOUNT],
      assign: [PERMISSION_KEYS.ASSIGN_ROLE_TO_ACCOUNT]
    }"
  >
      ...
      <div class="flex items-center gap-4">
        <div v-if="row.profile?.photo">
          <el-image
            ...
            :preview-src-list="[row.profile.photo]"
            fit="cover"
            class="w-[64px] h-[64px] cursor-pointer rounded-md"
