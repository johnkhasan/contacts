<template>
  <div class="flex justify-between gap-4">
    <button @click="routeBack" class="rounded-md border p-2 border-surface-30 bg-surface-40">
      <IconArrowLeft class="w-5 h-5 text-primary-color" />
    </button>
...
import { IconArrowLeft, IconFilter, IconSearch } from "#components";
...
const routeBack = () => {
  props.tab.sostavNumber = undefined;
}
